---
title: "Rules"
description: "Game rules, approved bats, age eligibility, pitching limits, and playoff tiebreakers for Reading Babe Ruth Baseball League."
featured_image: ""
type: "page"
menu: ""
---

Reading Babe Ruth League games follow [OBR rules](https://www.umpirebible.com/OBR16/home.htm) with notable exceptions appropriate for recreational baseball, many of which are listed below.

---

## Age Eligibility

RBRL is a 13-15 year old league, with age eligibility based on the [Babe Ruth League age chart](https://baberuthleague.org/league-resources/baseball-age-chart). Players considered to be "Babe Ruth 12 year olds" can also play if they are no longer eligible for Reading Little League, which uses a different age cutoff.
...
<div class="bat-cert-grid">
  <div class="bat-cert-card bat-cert-approved">
    <img src="/images/rules/bbcor.jpg" alt="BBCOR Certified .50 stamp" class="bat-cert-img">
    <div class="bat-cert-status">Approved</div>
  </div>
  <div class="bat-cert-card bat-cert-approved">
    <img src="/images/rules/usabat.jpg" alt="USA Baseball bat stamp" class="bat-cert-img">
    <div class="bat-cert-status">Approved</div>
  </div>
  <div class="bat-cert-card bat-cert-rejected">
    <img src="/images/rules/usssa.jpg" alt="USSSA 1.15 BPF stamp" class="bat-cert-img">
    <div class="bat-cert-overlay">✗</div>
    <div class="bat-cert-status">Not Approved</div>
  </div>
</div>
